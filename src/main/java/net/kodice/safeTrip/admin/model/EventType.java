...
public class EventType implements Serializable {
	...
	@Id
	@SequenceGenerator(name = "EVENTTYPE_ID_GENERATOR", sequenceName = "eventType_id_seq")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "EVENTTYPE_ID_GENERATOR")
